...
public class NotifierConfiguration {
    ...
    public BotNotifier kafkaNotifier(
    ...
    public OutboxRelay outboxRelay(OutboxMessageService outboxMessageService, KafkaProperties kafkaProperties, KafkaTemplate<String, LinkUpdateEvent> kafkaTemplate, ObjectMapper objectMapper) {
