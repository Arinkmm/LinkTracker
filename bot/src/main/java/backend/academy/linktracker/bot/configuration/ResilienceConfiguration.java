...
public class ResilienceConfiguration {
    @Bean
    public CircuitBreaker scrapperCircuitBreaker(ResilienceProperties props) {
        ...
        return CircuitBreakerRegistry.of(config).circuitBreaker("scrapper-client");
    }

    @Bean
    public Retry scrapperRetry(ResilienceProperties props) {
        ...
        return RetryRegistry.of(config).retry("scrapper-client");
    }
