...
public class ListCommand implements Command {
    ...
    public String command() {
        return commandProperties.getCommands().get(InternalCommand.LIST.configKey).getName();
    }

    @Override
    public String description() {
        return commandProperties.getCommands().get(InternalCommand.LIST.configKey).getDescription();
    }
